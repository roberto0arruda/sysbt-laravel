...
<div class="card card-outline card-primary text-center">
  ...
  <table class="card-body table table-bordered table-striped table-hover">
    <thead>
      <tr>
    ...
    @empty
      <tr><td class="text-center" colspan="3">no categorias</td></tr>
    @endforelse
    </tbody>
  </table>
  <div class="card-footer text-muted">Categories footer</div>
</div>
@stop
